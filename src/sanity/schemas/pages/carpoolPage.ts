...
export default defineType({
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({
              ...
              title: "Icône",
              type: "string",
              options: { list: ["Euro", "Leaf", "Shield", "Clock", "Heart", "Star", "Zap"] },
            }),
          ],
        },
      ],
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({
              ...
              title: "Icône",
              type: "string",
              options: { list: ["Car", "Calendar", "Users", "Home", "MapPin"] },
            }),
          ],
        },
      ],
  ...
  preview: { prepare: () => ({ title: "🚗 Page Covoiturage" }) },
});
